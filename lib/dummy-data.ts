...
// Categories
const categories = ["electronics", "clothing", "home", "beauty", "sports", "toys", "food", "other"]
...
const dummyProducts = [
  ...
  },
  {
    ...
    description: "Modern bordslampa med justerbar ljusstyrka och färgtemperatur. Tidlös design som passar i alla hem.",
    price: 799,
  ...
  },
  {
    ...
    description: "Handgjorda praliner i lyxig presentförpackning. Innehåller 24 olika smaker av högsta kvalitet.",
    price: 249,
  ...
  },
  {
    ...
    description: "Snabb trådlös laddare kompatibel med alla moderna smartphones. Elegant design och LED-indikator.",
    price: 299,
  ...
  },
  {
    ...
    description: "Rymlig och slitstark ryggsäck perfekt för både vardagsbruk och äventyr. Flera fack och laptop-ficka.",
    price: 699,
...
export async function generateDummyProducts() {
  try {
    ...
    if (!snapshot.empty) {
      console.log("Database already has products, skipping dummy data generation")
      return false
    }
    ...
    for (const product of dummyProducts) {
      ...
      // Random company
      const companyId = dummyCompanyIds[Math.floor(Math.random() * dummyCompanyIds.length)]

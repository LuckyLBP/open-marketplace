        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Din integritet är viktig för oss. Här beskriver vi hur DealsMarket
              ...
              <div className="flex-1 bg-white p-6 md:p-8 rounded-lg shadow-md">
                <div className="prose max-w-none">
                  ...
                  <section id="introduction" className="mb-10">
                    ...
                    <p className="mb-4">
                      Denna sekretesspolicy beskriver hur DealsMarket AB
                      (org.nr. 555555-5555) ("vi", "oss" eller "DealsMarket")
                      samlar in, använder, delar och skyddar personuppgifter när
                      du använder vår webbplats på www.dealsmarket.se, våra
                  ...
                  <section id="data-sharing" className="mb-10">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        <strong>Företagsöverlåtelser:</strong> Om DealsMarket är
                  ...
                  <section id="data-subject-rights" className="mb-10">
                    ...
                    <p className="mt-4">
                      ...
                      kontakta oss via e-post på dataskydd@dealsmarket.se eller
                  ...
                  <section id="international-transfers" className="mb-10">
                    ...
                    <p className="mb-4">
                      DealsMarket är baserat i Sverige, och din information kan
                  ...
                  <section id="contact-info" className="mb-10">
                    ...
                    <div className="mb-4">
                      <p className="font-medium">DealsMarket AB</p>
                      <p>
                        Sveavägen 123
                        <br />
                        113 50 Stockholm
                    ...
                    <div className="mb-4">
                      ...
                      <p>
                        E-post:{' '}
                        <a
                          href="mailto:dataskydd@dealsmarket.se"
                          className="text-purple-600 hover:underline"
                        >
                          dataskydd@dealsmarket.se
                        </a>
                        <br />

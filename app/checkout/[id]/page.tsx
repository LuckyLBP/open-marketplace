    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-purple-50 to-white p-4">
        <div className="text-center max-w-md">
          ...
          <p className="mb-6 text-muted-foreground">{t("This deal may have expired or been removed.")}</p>
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center text-sm text-muted-foreground">
                    ...
                    <span>
                      {t("Time Left")}: {deal.timeLeft.hours.toString().padStart(2, "0")}:
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between text-sm text-muted-foreground">
                  ...
                  <span>
                    {new Intl.NumberFormat("sv-SE", { style: "currency", currency: "SEK" }).format(
                      deal.price * (deal.feePercentage / 100),
                    )}
                  </span>
                </div>
                <Separator />
                <div className="flex justify-between font-bold text-lg">
                  ...
                  <span>
                    {new Intl.NumberFormat("sv-SE", { style: "currency", currency: "SEK" }).format(
                      deal.price * (1 + deal.feePercentage / 100),
                    )}
                  </span>
                </div>

                <div className="bg-purple-50 p-4 rounded-lg mt-4">
                  <h3 className="font-medium mb-2">{t("Payment Information")}</h3>

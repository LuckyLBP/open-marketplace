...
export default function CreateDeal() {
    ...
    const handleRemoveImage = (index: number) => {
        setImages((prev) => {
            ...
            if (newImages[index].isPrimary && newImages.length > 1) {
                const nextIndex =
                    index === newImages.length - 1 ? 0 : index + 1;
    ...
    const handleSpecificationGroupTitleChange = (
        groupIndex: number,
        title: string
    ) => {
        setSpecificationGroups((prev) => {
    ...
    const validateForm = () => {
        ...
        if (
            ...
            toast({
                title: t("Error"),
                description: t(
                    "Please enter a valid original price or leave it blank."
                ),
                variant: "destructive"
            });
            setActiveTab("basic");
        ...
        if (images.length === 0) {
            toast({
                title: t("Error"),
                description: t(
                    "Please upload at least one image for your deal."
                ),
                variant: "destructive"
            });
            setActiveTab("images");
    ...
    const uploadImages = async () => {
        ...
        setImages((prev) =>
            prev.map((img) => ({ ...img, uploading: true, progress: 0 }))
        );

        const uploadPromises = images.map(async (image, index) => {
            const storageRef = ref(
                storage,
                `deals/${user?.uid}/${Date.now()}_${image.file.name}`
            );
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await addDoc(collection(db, "deals"), {
                ...
                sku,
                specifications:
                    cleanedSpecGroups.length > 0 ? cleanedSpecGroups : null,
                ...
                <Card>
                    <form onSubmit={handleSubmit}>
                        <CardHeader>
                            ...
                            <CardDescription>
                                {t("Fill in the details for your new deal")}
                            </CardDescription>
                        </CardHeader>
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        >
                                            ...
                                            <option value="halsa-skonhet">
                                                Hälsa & Skönhet
                                            </option>
                                            <option value="hobby-fritid">
                                                Hobby & Fritid
                                            </option>
                                            <option value="other">
                                                Övrigt
                                                    ...
                                                    <div className="flex-grow">
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <Input
                                                                ...
                                                                placeholder={t(
                                                                    "Enter a key feature of your product"
                                                                )}
                                                            />
                                                        </div>
                                                    </div>
                                                    ...
                                                    >
                                                        <div className="flex justify-between items-center">
                                                            <Input
                                                                ...
                                                                onChange={(e) =>
                                                                    handleSpecificationGroupTitleChange(
                                                                        groupIndex,
                                                                        e.target
                                                                            .value
                                                                    )
                                                            ...
                                                            <Button
                                                                ...
                                                                size="icon"
                                                                onClick={() =>
                                                                    handleRemoveSpecificationGroup(
                                                                        groupIndex
                                                                    )
                                                                }
                                                                className="h-8 w-8 text-red-600"

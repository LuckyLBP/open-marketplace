      ...
      try {
        ...
        const partnersData: Partner[] = snapshot.docs.map((doc) => {
          ...
          return {
            ...
            description:
              data.description ||
              'En partner i Marknadsplatsen-nätverket som erbjuder exklusiva tidsbegränsade erbjudanden.',
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Upptäck de ledande företagen som samarbetar med Marknadsplatsen
              för att erbjuda exklusiva tidsbegränsade erbjudanden.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg opacity-90 mb-8">
                ...
                Marknadsplatsen och erbjud tidsbegränsade erbjudanden till

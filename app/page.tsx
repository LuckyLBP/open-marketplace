                ...
                <section className="py-20 bg-gradient-to-b from-purple-50 to-white">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
                            Upptäck exklusiva erbjudanden från ledande företag
                            med begränsad tid. Ju kortare tid, desto bättre
                            pris!
                        </p>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                            ...
                            >
                                <div className="bg-blue-50 rounded-lg p-6 text-center transition-all group-hover:shadow-md group-hover:bg-blue-100">
                                    ...
                                    <h3 className="font-medium">Hemmet</h3>
                                </div>
                            </Link>
                            ...
                            <Link
                                ...
                                className="group"
                            >
                                <div className="bg-amber-50 rounded-lg p-6 text-center transition-all group-hover:shadow-md group-hover:bg-amber-100">
                                    <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-amber-200">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                ...
                                <div className="p-4">
                                    <h3 className="font-semibold mb-1 line-clamp-1">
                                        Premium Bluetooth Hörlurar
                                    </h3>
                                    <p className="text-sm text-gray-500 mb-2 line-clamp-2">
                                        Trådlösa hörlurar med aktiv
                                        brusreducering och kristallklart ljud.
                                    </p>
                            ...
                            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                ...
                                <div className="p-4">
                                    <h3 className="font-semibold mb-1 line-clamp-1">
                                        Smart Fitness Klocka
                                    </h3>
                                    <p className="text-sm text-gray-500 mb-2 line-clamp-2">
                                        Håll koll på din hälsa med denna smarta
                                        klocka. Spårar steg, sömn och puls.
                                    </p>
                                    <div className="flex justify-between items-center">
                                        <div className="flex items-center text-xs text-gray-500">
                                            <Clock className="h-3 w-3 mr-1" />
                            ...
                            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                ...
                                <div className="p-4">
                                    ...
                                    <p className="text-sm text-gray-500 mb-2 line-clamp-2">
                                        Handgjorda praliner i lyxig
                                        presentförpackning. Innehåller 24 olika
                                        smaker.
                                    </p>
                                    <div className="flex justify-between items-center">
                                        <div className="flex items-center text-xs text-gray-500">
                            ...
                            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                ...
                                <div className="p-4">
                                    <h3 className="font-semibold mb-1 line-clamp-1">
                                        Organisk Hudvårdsset
                                    </h3>
                                    <p className="text-sm text-gray-500 mb-2 line-clamp-2">
                                        Komplett hudvårdsrutin med rengöring,
                                        toner, serum och fuktkräm.
                                    </p>
                                    <div className="flex justify-between items-center">
                                        <div className="flex items-center text-xs text-gray-500">
                                            <Clock className="h-3 w-3 mr-1" />
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="bg-white p-6 rounded-lg shadow-md text-center">
                                ...
                                <h3 className="text-xl font-semibold mb-2">
                                    Företag skapar erbjudanden
                                </h3>
                                <p className="text-gray-600">
                                    Företag lägger upp tidsbegränsade
                                    erbjudanden med olika varaktighet.
                                </p>
                            </div>
                            <div className="bg-white p-6 rounded-lg shadow-md text-center">
                                <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <h3 className="text-xl font-semibold mb-2">
                                    Kunder hittar erbjudanden
                                </h3>
                                <p className="text-gray-600">
                                    Bläddra bland aktiva erbjudanden och se
                                    realtidsräknare för varje erbjudande.
                                </p>
                            </div>
                            <div className="bg-white p-6 rounded-lg shadow-md text-center">
                                <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <p className="text-gray-600">
                                    Köp erbjudanden enkelt och säkert med
                                    Stripe-betalningar.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="md:flex items-center justify-between">
                                <div className="mb-6 md:mb-0 md:mr-8">
                                    ...
                                    <p className="text-lg opacity-90 mb-6">
                                        Registrera dig idag och börja sälja dina
                                        produkter med tidsbegränsade
                                        erbjudanden.
                                    </p>
